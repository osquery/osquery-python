...
class call_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'registry', None, None, ), # 1
    (2, TType.STRING, 'item', None, None, ), # 2
    (3, TType.MAP, 'request', (TType.STRING,None,TType.STRING,None), None, ), # 3
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.registry = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
          self.item = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.MAP:
  ...
  def write(self, oprot):
    ...
    if self.registry is not None:
      ...
      oprot.writeString(self.registry)
      oprot.writeFieldEnd()
    if self.item is not None:
      oprot.writeFieldBegin('item', TType.STRING, 2)
      oprot.writeString(self.item)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.registry)
