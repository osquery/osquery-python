...
class Processor(osquery.extensions.Extension.Processor, Iface, TProcessor):
  ...
  def process_extensions(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("extensions", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_options(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("options", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_registerExtension(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("registerExtension", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_deregisterExtension(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("deregisterExtension", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_getQueryColumns(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("getQueryColumns", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class extensions_result:
  ...
  thrift_spec = (
    (0, TType.MAP, 'success', (TType.I64,None,TType.STRUCT,(InternalExtensionInfo, InternalExtensionInfo.thrift_spec)), None, ), # 0
  )
...
class options_result:
  ...
  thrift_spec = (
    (0, TType.MAP, 'success', (TType.STRING,None,TType.STRUCT,(InternalOptionInfo, InternalOptionInfo.thrift_spec)), None, ), # 0
  )
...
class registerExtension_args:
  ...
  thrift_spec = (
    ...
    (2, TType.MAP, 'registry', (TType.STRING,None,TType.MAP,(TType.STRING,None,TType.LIST,(TType.MAP,(TType.STRING,None,TType.STRING,None)))), None, ), # 2
  )
